                  ...
                  {activeLines.length === 0 ? (
                    ...
                    activeLines.map((line, idx) => (
                      <tr key={line.itemId} className="hover:bg-slate-50/50">
                        ...
                        <td className="p-3 text-center font-medium">{line.bookQty} {line.unit}</td>
                        <td className="p-3 text-center font-bold text-slate-900">{line.actualQty} {line.unit}</td>
                        <td className="p-3 text-center">
                          <span className={`inline-block px-1.5 py-0.2 rounded font-black text-[10px] ${
              ...
              audits.map(aud => (
                <div key={aud.id} className="border border-stone-200 rounded-xl p-4 space-y-2.5 hover:shadow-xs transition text-xs">
                  <div className="flex justify-between items-start">
                    <div>
                      <strong className="text-slate-950 tracking-wide block">{aud.id}</strong>
