      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-[#e5e5e5] p-5 rounded-2xl shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            <span className="text-xl font-black text-matte-black block font-mono">{formatVnd(grandTotalAssetValue)}</span>
        ...
        <div className="bg-white border border-[#e5e5e5] p-5 rounded-2xl shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            <span className="text-xl font-black block text-matte-black font-mono">
        ...
        <div className="bg-white border border-[#e5e5e5] p-5 rounded-2xl shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            <span className="text-xl font-black text-matte-black block font-mono">-{formatVnd(totalMonthlyDepreciation)}</span>
                        ...
                        >
                          <td className="p-4">
                            <div className="space-y-0.5">
                              ...
                              <span className="text-[9px] text-[#a5a5a5] font-mono tracking-wider block uppercase">
                          ...
                          <td className="p-4 text-right font-mono font-bold text-matte-black">
                            {formatVnd(item.pricePerUnit)}
                          </td>
                          <td className="p-4 text-right font-mono text-sm text-matte-black font-extrabold">
                            <div className="space-y-0.5">
                  ...
                  {filteredLedger.length === 0 ? (
                    ...
                    filteredLedger.map(row => (
                      <tr key={row.id} className="hover:bg-warm-white/30 transition text-[11px]">
                        <td className="p-3.5 text-[#a5a5a5] font-mono">
                        ...
                        <td className="p-3.5 text-center font-black text-matte-black font-mono">
                          {row.balanceAfter}
                        </td>
                ...
                <div className="space-y-5 animate-fadeIn">
                  ...
                  <div className="bg-purple-50 border border-purple-100 p-4 rounded-xl text-center space-y-3.5 shadow-xs">
                    <div className="space-y-1">
                      ...
                      <strong className="text-xl font-mono font-black text-purple-700 block">
                  ...
                  {calculatedConsumption !== null && (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <strong className="text-matte-black font-mono">{calculatedConsumption.toFixed(1)} Lít</strong>
                      </div>
                      <div className="flex justify-between items-center text-xs">
                        <span className="text-mid-gray font-medium">Đổi can tương đương trừ kho:</span>
                        <strong className="text-red-600 font-mono">-{Math.floor(calculatedConsumption / 20) || 1} Can (20L)</strong>
                      </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-5 font-sans text-xs">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-white border border-[#e5e5e5] rounded-xl pl-3.5 pr-12 py-3 text-xs text-matte-black focus:outline-none focus:border-forest-green transition-colors font-mono font-bold"
                        />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-[#e5e5e5] rounded-xl px-3.5 py-3 text-xs text-matte-black focus:outline-none focus:border-forest-green transition-colors font-mono font-bold"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-[#e5e5e5] rounded-xl px-3.5 py-3 text-xs text-matte-black focus:outline-none focus:border-forest-green transition-colors font-mono"
                      />
                    </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-[#e5e5e5] rounded-xl px-3 py-2 text-xs text-matte-black focus:outline-none focus:border-purple-500 font-mono"
                            />
                          </div>
                    ...
                    <div className="bg-stone-50 border border-[#e5e5e5] p-4 rounded-2xl space-y-1">
                      ...
                      <div className="pt-2 border-t border-stone-200 flex items-center justify-between text-slate-800 text-xs font-black uppercase tracking-wide">
                        ...
                        <span className="text-xl font-extrabold text-forest-green font-mono">
                          {formatVnd((Number(itemPrice) || 0) * (Number(itemQuantity) || 0))}
                        </span>
                      </div>
                    </div>
